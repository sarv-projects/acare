...
#ifndef ACARE_MSGS__MSG__DETAIL__VISION_RESULT__TRAITS_HPP_
#define ACARE_MSGS__MSG__DETAIL__VISION_RESULT__TRAITS_HPP_
...
inline void to_yaml(
  const acare_msgs::msg::VisionResult & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const acare_msgs::msg::VisionResult & msg)
{
  return acare_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<acare_msgs::msg::VisionResult>()
{
  return "acare_msgs::msg::VisionResult";
}

template<>
inline const char * name<acare_msgs::msg::VisionResult>()
{
  return "acare_msgs/msg/VisionResult";
}

template<>
struct has_fixed_size<acare_msgs::msg::VisionResult>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<acare_msgs::msg::VisionResult>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<acare_msgs::msg::VisionResult>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ACARE_MSGS__MSG__DETAIL__VISION_RESULT__TRAITS_HPP_
