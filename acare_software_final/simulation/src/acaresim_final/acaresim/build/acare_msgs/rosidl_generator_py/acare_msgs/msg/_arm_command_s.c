...
bool acare_msgs__msg__arm_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("acare_msgs.msg._arm_command.ArmCommand", full_classname_dest, 38) == 0);
  }
  acare_msgs__msg__ArmCommand * ros_message = _ros_message;
  {  // command
  ...
  {  // velocity_scale
    ...
    ros_message->velocity_scale = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // accel_limit
...
PyObject * acare_msgs__msg__arm_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("acare_msgs.msg._arm_command");
