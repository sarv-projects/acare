...
class GripperCommand(metaclass=Metaclass_GripperCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.force_target = kwargs.get('force_target', float())
    ...
    def __eq__(self, other):
        ...
        if self.command != other.command:
            return False
        if self.force_target != other.force_target:
            return False
        return True
    ...
    @builtins.property
    def force_target(self):
        """Message field 'force_target'."""
        return self._force_target

    @force_target.setter
    def force_target(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'force_target' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'force_target' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._force_target = value
