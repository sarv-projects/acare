...
class HandStatus(metaclass=Metaclass_HandStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.palm_up = kwargs.get('palm_up', bool())
    ...
    @builtins.property
    def palm_up(self):
        """Message field 'palm_up'."""
        return self._palm_up

    @palm_up.setter
    def palm_up(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'palm_up' field must be of type 'bool'"
        self._palm_up = value
