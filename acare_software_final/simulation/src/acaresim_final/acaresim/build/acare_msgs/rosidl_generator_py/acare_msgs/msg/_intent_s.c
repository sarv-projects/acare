...
bool acare_msgs__msg__intent__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("acare_msgs.msg._intent.Intent", full_classname_dest, 29) == 0);
  }
  acare_msgs__msg__Intent * ros_message = _ros_message;
  {  // tool
...
PyObject * acare_msgs__msg__intent__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("acare_msgs.msg._intent");
