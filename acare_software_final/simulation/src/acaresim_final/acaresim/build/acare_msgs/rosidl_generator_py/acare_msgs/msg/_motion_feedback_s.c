...
bool acare_msgs__msg__motion_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("acare_msgs.msg._motion_feedback.MotionFeedback", full_classname_dest, 46) == 0);
  }
  acare_msgs__msg__MotionFeedback * ros_message = _ros_message;
  {  // success
  ...
  {  // joint_currents
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->joint_currents.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of MotionFeedback */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("acare_msgs.msg._motion_feedback");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotionFeedback");
  ...
  {  // joint_currents
    ...
    if (ros_message->joint_currents.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->joint_currents.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->joint_currents.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
