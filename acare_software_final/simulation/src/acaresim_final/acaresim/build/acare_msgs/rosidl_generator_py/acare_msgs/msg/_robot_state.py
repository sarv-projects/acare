...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    def __init__(self, **kwargs):
        ...
        self.active_user_id = kwargs.get('active_user_id', str())
    ...
    def __eq__(self, other):
        ...
        if self.state != other.state:
            return False
        if self.active_user_id != other.active_user_id:
            return False
        return True
    ...
    def active_user_id(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'active_user_id' field must be of type 'str'"
