...
bool acare_msgs__msg__safety_alert__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("acare_msgs.msg._safety_alert.SafetyAlert", full_classname_dest, 40) == 0);
  }
  acare_msgs__msg__SafetyAlert * ros_message = _ros_message;
  {  // severity
...
{
  /* NOTE(esteve): Call constructor of SafetyAlert */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("acare_msgs.msg._safety_alert");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SafetyAlert");
