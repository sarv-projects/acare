...
bool acare_msgs__msg__state_transition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("acare_msgs.msg._state_transition.StateTransition", full_classname_dest, 48) == 0);
  }
  acare_msgs__msg__StateTransition * ros_message = _ros_message;
  {  // target_state
...
{
  /* NOTE(esteve): Call constructor of StateTransition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("acare_msgs.msg._state_transition");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateTransition");
