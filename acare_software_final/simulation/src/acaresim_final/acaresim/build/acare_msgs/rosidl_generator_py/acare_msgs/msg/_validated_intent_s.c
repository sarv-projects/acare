...
bool acare_msgs__msg__validated_intent__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("acare_msgs.msg._validated_intent.ValidatedIntent", full_classname_dest, 48) == 0);
  }
  acare_msgs__msg__ValidatedIntent * ros_message = _ros_message;
  {  // tool
  ...
  {  // authenticated
    PyObject * field = PyObject_GetAttrString(_pymsg, "authenticated");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->authenticated = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ValidatedIntent */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("acare_msgs.msg._validated_intent");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ValidatedIntent");
  ...
  {  // authenticated
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->authenticated ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "authenticated", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
