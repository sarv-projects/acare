...
static const _ArmCommand_type_support_symbol_names_t _ArmCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, ArmCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acare_msgs, msg, ArmCommand)),
  }
};
...
{
  return &::acare_msgs::msg::rosidl_typesupport_cpp::ArmCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, acare_msgs, msg, ArmCommand)() {
  return get_message_type_support_handle<acare_msgs::msg::ArmCommand>();
}
