...
static const _HandStatus_type_support_symbol_names_t _HandStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, HandStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acare_msgs, msg, HandStatus)),
  }
};
...
{
  return &::acare_msgs::msg::rosidl_typesupport_cpp::HandStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, acare_msgs, msg, HandStatus)() {
  return get_message_type_support_handle<acare_msgs::msg::HandStatus>();
}
