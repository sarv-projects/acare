...
static const _StateTransition_type_support_symbol_names_t _StateTransition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, StateTransition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acare_msgs, msg, StateTransition)),
  }
};
...
{
  return &::acare_msgs::msg::rosidl_typesupport_cpp::StateTransition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, acare_msgs, msg, StateTransition)() {
  return get_message_type_support_handle<acare_msgs::msg::StateTransition>();
}
