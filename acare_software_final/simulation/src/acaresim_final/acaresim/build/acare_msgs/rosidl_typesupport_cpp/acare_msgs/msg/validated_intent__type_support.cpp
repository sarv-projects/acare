...
static const _ValidatedIntent_type_support_symbol_names_t _ValidatedIntent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, ValidatedIntent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acare_msgs, msg, ValidatedIntent)),
  }
};
...
{
  return &::acare_msgs::msg::rosidl_typesupport_cpp::ValidatedIntent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, acare_msgs, msg, ValidatedIntent)() {
  return get_message_type_support_handle<acare_msgs::msg::ValidatedIntent>();
}
