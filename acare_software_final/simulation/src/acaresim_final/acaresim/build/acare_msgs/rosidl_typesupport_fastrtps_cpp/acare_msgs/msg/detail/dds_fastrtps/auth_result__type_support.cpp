...
#include "acare_msgs/msg/detail/auth_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const acare_msgs::msg::AuthResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  acare_msgs::msg::AuthResult & ros_message)
{
  // Member: user_id
  cdr >> ros_message.user_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_acare_msgs
max_serialized_size_AuthResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = acare_msgs::msg::AuthResult;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_acare_msgs
max_serialized_size_key_AuthResult(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const acare_msgs::msg::AuthResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<acare_msgs::msg::AuthResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AuthResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const acare_msgs::msg::AuthResult *>(
...
static size_t _AuthResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AuthResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AuthResult__callbacks = {
  "acare_msgs::msg",
  "AuthResult",
...
static rosidl_message_type_support_t _AuthResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AuthResult__callbacks,
...
get_message_type_support_handle<acare_msgs::msg::AuthResult>()
{
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_AuthResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, AuthResult)() {
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_AuthResult__handle;
}
