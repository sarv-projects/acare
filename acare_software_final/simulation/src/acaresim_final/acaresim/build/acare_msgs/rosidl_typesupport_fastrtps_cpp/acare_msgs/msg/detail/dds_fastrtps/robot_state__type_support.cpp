...
#include "acare_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.active_user_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = acare_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const acare_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<acare_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
