...
#include "acare_msgs/msg/detail/safety_alert__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const acare_msgs::msg::SafetyAlert & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  acare_msgs::msg::SafetyAlert & ros_message)
{
  // Member: severity
  cdr >> ros_message.severity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = acare_msgs::msg::SafetyAlert;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const acare_msgs::msg::SafetyAlert *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<acare_msgs::msg::SafetyAlert *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SafetyAlert__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const acare_msgs::msg::SafetyAlert *>(
...
static size_t _SafetyAlert__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SafetyAlert(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SafetyAlert__callbacks = {
  "acare_msgs::msg",
  "SafetyAlert",
...
static rosidl_message_type_support_t _SafetyAlert__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SafetyAlert__callbacks,
...
{
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_SafetyAlert__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, SafetyAlert)() {
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_SafetyAlert__handle;
}
