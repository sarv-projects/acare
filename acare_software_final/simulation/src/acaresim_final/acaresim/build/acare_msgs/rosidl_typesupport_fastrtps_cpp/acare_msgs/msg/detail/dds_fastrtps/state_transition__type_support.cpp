...
#include "acare_msgs/msg/detail/state_transition__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const acare_msgs::msg::StateTransition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  acare_msgs::msg::StateTransition & ros_message)
{
  // Member: target_state
  cdr >> ros_message.target_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = acare_msgs::msg::StateTransition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const acare_msgs::msg::StateTransition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<acare_msgs::msg::StateTransition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StateTransition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const acare_msgs::msg::StateTransition *>(
...
static size_t _StateTransition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StateTransition(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StateTransition__callbacks = {
  "acare_msgs::msg",
  "StateTransition",
...
static rosidl_message_type_support_t _StateTransition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StateTransition__callbacks,
...
get_message_type_support_handle<acare_msgs::msg::StateTransition>()
{
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_StateTransition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acare_msgs, msg, StateTransition)() {
  return &acare_msgs::msg::typesupport_fastrtps_cpp::_StateTransition__handle;
}
