...
{
  new (message_memory) acare_msgs::msg::EmergencySignal(_init);
}

void EmergencySignal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<acare_msgs::msg::EmergencySignal *>(message_memory);
  typed_message->~EmergencySignal();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember EmergencySignal_message_member_array[2] = {
  {
    "reason",  // name
    ...
    offsetof(acare_msgs::msg::EmergencySignal, reason),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(acare_msgs::msg::EmergencySignal, source),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EmergencySignal_message_members = {
  ...
  2,  // number of fields
  sizeof(acare_msgs::msg::EmergencySignal),
...
get_message_type_support_handle<acare_msgs::msg::EmergencySignal>()
{
  return &::acare_msgs::msg::rosidl_typesupport_introspection_cpp::EmergencySignal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acare_msgs, msg, EmergencySignal)() {
  return &::acare_msgs::msg::rosidl_typesupport_introspection_cpp::EmergencySignal_message_type_support_handle;
}
