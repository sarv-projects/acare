...
{
  new (message_memory) acare_msgs::msg::StateTransition(_init);
}

void StateTransition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<acare_msgs::msg::StateTransition *>(message_memory);
  typed_message->~StateTransition();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember StateTransition_message_member_array[2] = {
  {
    "target_state",  // name
    ...
    offsetof(acare_msgs::msg::StateTransition, target_state),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(acare_msgs::msg::StateTransition, reason),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StateTransition_message_members = {
  ...
  2,  // number of fields
  sizeof(acare_msgs::msg::StateTransition),
...
{
  return &::acare_msgs::msg::rosidl_typesupport_introspection_cpp::StateTransition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acare_msgs, msg, StateTransition)() {
  return &::acare_msgs::msg::rosidl_typesupport_introspection_cpp::StateTransition_message_type_support_handle;
}
