...
**Path:** `/mnt/c/Users/Sonali/Desktop/acare`  
**Date:** ___________  
...
- [ ] Check all nodes running: `ros2 node list`
  - Expected: `/voice_node`, `/dialogue_node`, `/auth_node`, `/state_manager`, `/planner_node`, `/interface_node`, `/vision_node`, `/safety_node`, `/log_node`, `/admin_node`
...
### Critical API Keys (in `acare_voice/.env`)
```
